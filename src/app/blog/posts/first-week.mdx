...
- I've added over X new performances based on direct nominations from all of you
  and from more scouring of the subreddit for posts where folks are discussing
  great live performances.
- I've added [a page](/votes) where you can see all of the votes so far, along
  with some analysis of them.
...
- I've added Spotify embeds for all of the 2024 shows that were added to Spotify
  this week.
...
- I've made
  [the GitHub repo](https://github.com/jamesbvaughan/live-gizz-rankings) public.
