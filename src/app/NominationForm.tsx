      ...
      <Form action={formAction}>
        <div className="flex space-x-2">
          <input
            ...
            required
            disabled={isPending}
            className="peer form-input border-muted placeholder:text-muted-2 focus:border-foreground disabled:text-muted grow border-2 bg-transparent p-2 text-base focus:ring-0"
            name="message"
