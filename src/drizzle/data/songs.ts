...
import { seedAlbumObjects } from "./albums";
...
export const seedSongs = {
  ...
  elbow: {
    ...
    slug: "elbow",
    title: "Elbow",
    albumId: seedAlbumObjects.tbb.id,
  },
  muckraker: {
  ...
  eyesLikeTheSky: {
    ...
    albumId: seedAlbumObjects.elts.id,
  },
  yearOfOurLord: {
  ...
  headOn: {
    ...
    slug: "head-on-pill",
    title: "Head On/Pill",
    albumId: seedAlbumObjects.fafyl.id,
  },
  imNotAMan: {
  ...
  alludaMajaka: {
    ...
    slug: "alluda-majaka",
    title: "Alluda Majaka",
    albumId: seedAlbumObjects.oddments.id,
  },
  stressin: {
  ...
  imInYourMind: {
    ...
    albumId: seedAlbumObjects.mindFuzz.id,
  },
  imNotInYourMind: {
  ...
  theRiver: {
    ...
    slug: "the-river",
    title: "The River",
    albumId: seedAlbumObjects.quarters.id,
  },
  infiniteRise: {
  ...
  sense: {
    ...
    slug: "sense",
    title: "Sense",
    albumId: seedAlbumObjects.pmdb.id,
  },
  bone: {
  ...
  robotStop: {
    ...
    slug: "robot-stop",
    title: "Robot Stop",
    albumId: seedAlbumObjects.nonagon.id,
  },
  bigFigWasp: {
  ...
  rattlesnake: {
    ...
    slug: "rattlesnake",
    title: "Rattlesnake",
    albumId: seedAlbumObjects.fmb.id,
  },
  melting: {
  ...
  aNewWorld: {
    ...
    slug: "a-new-world",
    title: "A New World",
    albumId: seedAlbumObjects.motu.id,
  },
  alteredBeastI: {
  ...
  sketchesOfBruswickEastI: {
    ...
    albumId: seedAlbumObjects.sketches.id,
  },
  countdown: {
  ...
  crumblingCastle: {
    ...
    albumId: seedAlbumObjects.poly.id,
  },
  polygondwanaland: {
  ...
  beginnersLuck: {
    ...
    albumId: seedAlbumObjects.gumbootSoup.id,
  },
  greenhouseHeatDeath: {
  ...
  fishingForFishies: {
    ...
    albumId: seedAlbumObjects.fff.id,
  },
  boogiemanSam: {
  ...
  planetB: {
    ...
    slug: "planet-b",
    title: "Planet B",
    albumId: seedAlbumObjects.itrn.id,
  },
  marsForTheRich: {
  ...
  kglwIntro: {
    ...
    slug: "kglw-intro",
    title: "K.G.L.W.",
    albumId: seedAlbumObjects.kg.id,
  },
  automation: {
  ...
  ifNotNowThenWhen: {
    ...
    albumId: seedAlbumObjects.lw.id,
  },
  one: {
  ...
  yours: {
    ...
    slug: "yours",
    title: "Yours",
    albumId: seedAlbumObjects.bf3k.id,
  },
  shanghai: {
  ...
  theDrippingTap: {
    ...
    albumId: seedAlbumObjects.og.id,
  },
  magentaMountain: {
  ...
  timeland: {
    ...
    slug: "timeland",
    title: "Timeland",
    albumId: seedAlbumObjects.madeInTimeland.id,
  },
  smokeAndMirrors: {
  ...
  mycelium: {
    ...
    slug: "mycelium",
    title: "Mycelium",
    albumId: seedAlbumObjects.iceDeath.id,
  },
  iceV: {
  ...
  theLandBeforeTimeland: {
    ...
    albumId: seedAlbumObjects.laminatedDenim.id,
  },
  hypertension: {
  ...
  change: {
    ...
    slug: "change",
    title: "Change",
    albumId: seedAlbumObjects.changes.id,
  },
  hateDancin: {
  ...
  motorSpirit: {
    ...
    slug: "motor-spirit",
    title: "Motor Spirit",
    albumId: seedAlbumObjects.petro.id,
  },
  supercell: {
  ...
  theia: {
    ...
    slug: "theia",
    title: "Theia",
    albumId: seedAlbumObjects.tsc.id,
  },
  theSilverCord: {
  ...
  mirageCity: {
    ...
    slug: "mirage-city",
    title: "Mirage City",
    albumId: seedAlbumObjects.b741.id,
  },
  antarctica: {
